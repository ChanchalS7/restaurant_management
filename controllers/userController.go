...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		//conver the JSON data coming from postman to something that golang understands
		...
		if validationErr != nil {
			c.JSON(http.StatusBadRequest, gin{"error": validationErr.Error()})
			return
		}
		...
		//Create some extra details for the user object - created_at, update_at, ID
		...
		//if all ok, then you insert this new user into user collection
