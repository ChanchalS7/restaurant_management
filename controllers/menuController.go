...
func GetMenus() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cacel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occurred while listing the new items"})
		}
		var allMenus []bson.M
...
func GetMenu() gin.HandlerFunc {
	return func(*gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while fteching the menu"})
		}
